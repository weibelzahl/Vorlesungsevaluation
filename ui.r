    ...
    selectInput('kategorie', 'Studiengang und Modul/Fach', choices = list(
      `BSc General Management 1. Semester` = 
        c(Alle = 'BScGM1', 
          ...
          "Englisch I; N.N." = "BScGM1_10_3",
          "2. Fremdsprache; Chinesisch - Weihong Chen-Dieckmann" = "BScGM1_11_1",
          "2. Fremdsprache; Spanisch Fortgeschrittene - Mónica Naranjo-Merboldt" = "BScGM1_11_2",
          "2. Fremdsprache; Spanisch - Heike Georges" = "BScGM1_11_3",
          "2. Fremdsprache; Französisch - Heike Georges" = "BScGM1_11_4",
      ...
      `BSc General Management 3. Semester` = 
        c(Alle = 'BScGM3', 
          ...
          "Fallstudien / Projektarbeit; Städtischer Auftraggeber - Prof. Dr. Riekhof" = "BScGM3_7_1",
          "Fallstudien / Projektarbeit; GIS AG Hannover - Prof. Dr. Schüle" = "BScGM3_7_2",
          "Fallstudien / Projektarbeit; Bäckerei Thiele - Prof. Dr. Riekhof" = "BScGM3_7_3",
          "Fallstudien / Projektarbeit; Ernst Neumärker GmbH &amp; Co. KG - Prof. Dr. Mörstedt" = "BScGM3_7_4",
          "Fallstudien / Projektarbeit; POCO Einrichtungsmärkte GmbH - Prof. Dr. Ahrens" = "BScGM3_7_5",
          "Fallstudien / Projektarbeit; Sartorius AG - Prof. Dr. Ahrens" = "BScGM3_7_6",
          "Fallstudien / Projektarbeit; ZE Zentrum für Entrepreneurship - Prof. Dr. Vollmar" = "BScGM3_7_7",
          "Fallstudien / Projektarbeit; YourCar GmbH, Göttingen - Prof. Dr. Vollmar" = "BScGM3_7_8",
          "Fallstudien / Projektarbeit; alto.Red GmbH - Prof. Dr. Sierke" = "BScGM3_7_9",
          "Fallstudien / Projektarbeit; Göttinger Filmnetzwerk e.V. - Prof. Dr. Sierke" = "BScGM3_7_10",
          ...
          "2. Fremdsprache III; Spanisch - Heike Georges" = "BScGM3_9_3",
          "2. Fremdsprache III; Französisch - Heike Georges" = "BScGM3_9_3",
